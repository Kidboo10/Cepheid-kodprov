...
There is also one unfinished JUnit test in com.cepheid.cloud.skel.MovieControllerTest
...
Right click on com.cepheid.cloud.skel.MovieControllerTest and select Run As -> JUnit Test
